...
import EditModal from "./EditMeasurement.vue";
export default {
    components: {
        EditModal,
    },
        ...
        remove(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete('/api/measurement/delete/' + id)
                        .then(response => {
                            Swal.fire(
                                'Deleted!',
