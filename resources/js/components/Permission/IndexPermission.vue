<template>
                        ...
                        <div class="card-header p-3">
                            ...
                            <div class="card-tools float-left">
                                <div class="input-group input-group-sm" >
                                    ...
                                    <button class="btn btn-success btn-sm ml-auto" @click="openAddModal"><i class="fas fa-user-plus"></i> Add</button>
                                </div>
                            </div>
    ...
    <script>
    import addModal from "./AddPermission.vue";
    import EditModal from "./EditPermission.vue";
    export default {
        components: {
            addModal,
            EditModal,
        ...
        methods: {
            ...
            getData(page){
                if (typeof page === 'undefined' || page.type == 'keyup'|| page.type == 'change'|| page.type == 'click') {
                    page = '/api/permission/list/?page=1';
                }
