<template>
    <div v-if="!can('list role') && !is('Super-Admin')">
        <not-found/>
    </div>
    <div v-else>
                        ...
                        <div class="card-header p-3">
                            ...
                            <div class="card-tools float-left">
                                <div class="input-group input-group-sm" >
                                    ...
                                    <button class="btn btn-success btn-sm ml-auto" @click="openAddModal" v-if="can('create role')"><i class="fas fa-user-plus"></i> Add</button>
                                </div>
                            </div>
    ...
    import EditModal from "./EditRole.vue";
    export default {
        components: {
            addModal,
            EditModal,
