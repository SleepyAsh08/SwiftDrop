...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2024 at 09:06 AM
...
(0, 'rendel reges', 'ati', 'rendel@gmail.com', '09099121548', 174, 'jrqereqreqrq', 'davao', 'saa', '8100', 'rendel reges', 'ati', '09099121548', 174, 'jrqereqreqrq', 'davao', 'saa', '8100', 'rendel reges', 'ati', '09099121548', 174, 'jrqereqreqrq', 'davao', 'saa', '8100', '5f4dcc3b5aa765d61d8327deb882cf99', '4ab151655c2b82cdf500e825ea74f4d5', '2024-11-22 04:58:42', '1732323522', 1);
...
(61, 'Beetroot', 14),
(62, 'Potatoes ', 14),
(63, 'Sweet Potatoes', 14),
(64, 'Turnips', 14),
(65, 'Radishes', 14),
(66, 'Carrots', 14),
(67, 'Collard Greens', 15),
(68, 'Spinach', 15),
(69, 'Cauliflower', 15),
(70, 'Broccoli', 15),
(71, 'Cabbage ', 15),
...
(1, 'Citrus Fruits', 1),
(2, 'Multiple Fruits', 1),
(3, 'Companion Livestock', 2),
(4, 'Work Livestock', 2),
(6, 'Fiber-Producing Livestock', 2),
(7, 'Food-Producing Livestock', 2),
(8, 'Aggregate Fruits', 1),
(9, 'Simple Fruits', 1),
(10, 'Other Poultry', 3),
(11, 'Egg-Laying Chicken', 3),
(12, 'Egg-Laying Ducks', 3),
(14, 'Root Vegetables', 4),
(15, 'Leafy Greens', 4),
(16, 'Medicinal & Aromatic', 5),
(17, 'Cereal Crops', 5),
(0, 'Berries', 1),
(0, 'Fruiting Vegetables', 4),
(0, 'Spice and Herb Crops', 5);
...
(0, 0, 'rendel reges', 'rendel@gmail.com', '2024-11-22 17:03:37', '', 167, '', '', '', '', '\r\n.\r\n00221+62+6', 'Bank Deposit', 'Pending', 'Pending', '1732323817');
...
(83, 'Brown & White Eggs', '97', '95', 77, 'product-featured-83.png', '<p style=\"list-style: disc; overflow-wrap: break-word; margin: 0px;\"><span class=\"a-list-item\" style=\"overflow-wrap: break-word; display: block;\">Brown eggs are a type of egg that, as the name suggests, have <strong>brown-colored shells</strong>. These eggs are just as nutritious and versatile as white eggs, and the primary difference between brown and white eggs lies in the breed of the hen that lays them and, to a lesser extent, their appearance.</span></p><li><p><strong>Shell Color</strong>:</p><ul><li>Brown eggs have a <strong>brown shell</strong>, ranging in shade from light brown to darker brown. The shade of brown depends on the specific breed of the hen.</li><li>The color of the eggshell does <strong>not affect the quality or taste</strong> of the egg. The internal contents—egg white (albumen) and yolk—are the same as in white eggs.</li><li>Brown eggs come in a variety of sizes, including <strong>small</strong>, <strong>medium</strong>, <strong>large</strong>, and <strong>jumbo</strong>. The size of the egg is generally determined by the age and size of the hen.</li><li>Larger hens tend to lay larger eggs, whether brown or white.</li><li>There is <strong>no difference in taste or nutritional value</strong> between brown and white eggs. The flavor and quality of an egg are determined more by the hen’s diet, living conditions, and how fresh the egg is.</li><li>Some people may perceive brown eggs as having a richer flavor, but this is likely a subjective difference, often influenced by factors such as the diet or environment of the chicken, rather than the color of the eggshell.</li></ul></li>', 'The main difference between brown eggs and white eggs is the breed of the hen that lays them.\r\nBrown egg-laying hens tend to be larger breeds, such as:\r\nRhode Island Red: Known for its hardiness and ability to lay large brown eggs.\r\nGenetics: The color of an egg’s shell is determined by the genetics of the hen. Hens with red or brown feathers and red earlobes typically lay brown eggs, while hens with white feathers and white earlobes tend to lay white eggs.\r\nLarger Hens: Larger chickens, such as the Rhode Island Red, tend to lay brown eggs. Smaller hens, like the White Leghorn, tend to produce white eggs.', '<ul><li style=\"list-style: disc; overflow-wrap: break-word; margin: 0px;\"><span class=\"a-list-item\" style=\"overflow-wrap: break-word; display: block; font-family: Arial;\"><li><strong>Calories</strong>: One large brown egg typically contains around <strong>70-80 calories</strong>.</li><li><strong>Protein</strong>: Eggs are an excellent source of high-quality protein. One large egg contains about <strong>6 grams of protein</strong>.</li><li><strong>Fat</strong>: Eggs have about <strong>5 grams of fat</strong>, with <strong>1.5 grams of saturated fat</strong> per large egg. The fat content varies depending on the hen’s diet.</li><li><strong>Cholesterol</strong>: Each large egg contains approximately <strong>185 milligrams</strong> of cholesterol, which is mostly concentrated in the yolk.</li><li><span style=\"font-weight: 700;\">Vitamin A</span>: Important for vision and immune function.</li><li><span style=\"font-weight: 700;\">Vitamin D</span>: Essential for calcium absorption and bone health.</li><li><span style=\"font-weight: 700;\">B vitamins</span> (especially B12, B2, and folate): Vital for energy production, brain health, and red blood cell formation.</li><li><span style=\"font-weight: 700;\">Iron</span>: Important for blood and oxygen circulation.</li><li><span style=\"font-weight: 700;\">Selenium</span>: An antioxidant that helps protect cells from damage.</li><li><span style=\"font-weight: 700;\">Calcium</span>: Eggs contain small amounts of calcium, important for bone health.</li></span></li></ul>', '<ul><li><ul><li>considered the highest quality in terms of both nutrition and taste.</li></ul></li></ul>', '<p><span style=\"color: rgb(32, 33, 36); font-family: arial, sans-serif; font-size: 16px;\">Offers aÂ </span><span style=\"color: rgb(32, 33, 36); font-family: arial, sans-serif; font-size: 16px;\">15 to 30-day window</span><span style=\"color: rgb(32, 33, 36); font-family: arial, sans-serif; font-size: 16px;\">Â in which customers can return a product and ask for a refund. Some businesses extend that period up to 90 days. Regardless of the time frame you choose, ensuring that you actually have a time frame is essential.</span><br></p>', 3, 1, 1, 29),
(84, 'carrots', '51', '39', 26, 'product-featured-84.png', '<h5>Carrots (Daucus carota)</h5><p>Carrots are one of the most popular and widely consumed root vegetables in the world. Known for their bright orange color (though they can come in a variety of colors), carrots are highly nutritious and versatile, used in both raw and cooked forms in a wide range of dishes. Carrots belong to the <strong>Apiaceae</strong> family, which also includes parsley, celery, and parsnips.</p><li>Carrots are typically <strong>long, tapered root vegetables</strong>, ranging in size from small (baby carrots) to large (up to 12 inches or more).</li><li>The <strong>color</strong> is most commonly <strong>orange</strong>, but carrots can also be found in other colors, including <strong>purple</strong>, <strong>yellow</strong>, <strong>red</strong>, and <strong>white</strong>. The color variations are often due to different varieties or growing conditions.</li><li>Carrots have a <strong>sweet, slightly earthy flavor</strong>, with the natural sugars in the vegetable becoming more pronounced when they are cooked.</li><li>When raw, they are <strong>crisp</strong> and <strong>refreshing</strong>, and they become tender when cooked, often becoming milder and sweeter.</li>', 'Carrots are an excellent source of beta-carotene, a type of vitamin A that is essential for vision, immune function, and skin health. They are also low in calories and provide a good amount of fiber and other important vitamins and minerals.\r\n\r\nCalories: 41 calories per 100 grams (about 3.5 oz)\r\nMacronutrients:\r\nCarbohydrates: 9.6 grams\r\nFiber: 2.8 grams\r\nProtein: 0.9 grams\r\nFat: 0.2 grams\r\nVitamins & Minerals:\r\nVitamin A: Carrots are exceptionally high in beta-carotene, which the body converts into vitamin A, an essential nutrient for maintaining good vision and skin health.\r\nVitamin C: Important for immune function, collagen production, and skin health.\r\nVitamin K1: Supports bone health and proper blood clotting.\r\nBiotin: A B-vitamin that supports metabolism.\r\nPotassium: Helps regulate blood pressure and maintain heart health.\r\nLutein: A type of antioxidant that is beneficial for eye health.\r\nCalcium: Important for bone health.\r\nIron: Supports oxygen transport in the blood.\r\n', '<div><ol><li><p><strong>Eye Health</strong>: Carrots are rich in <strong>beta-carotene</strong> (a precursor to vitamin A), which is vital for <strong>good vision</strong> and may help prevent conditions like <strong>night blindness</strong> and <strong>macular degeneration</strong>. Lutein in carrots also supports eye health by protecting against damage from UV light.</p></li><li><p><strong>Immunity</strong>: The <strong>vitamin C</strong> in carrots boosts the immune system and helps the body fight off infections. Vitamin C is also essential for the production of collagen, which is important for skin, bones, and joints.</p></li><li><p><strong>Digestive Health</strong>: Carrots are an excellent source of <strong>fiber</strong>, particularly <strong>soluble fiber</strong>, which helps maintain healthy digestion, regulate bowel movements, and prevent constipation.</p></li><li><p><strong>Skin Health</strong>: The <strong>vitamin A</strong> from beta-carotene is crucial for maintaining healthy skin. It can help reduce the appearance of wrinkles and improve skin tone. Some studies suggest that beta-carotene can protect skin from sun damage and enhance the skin\'s natural protection against UV rays.</p></li><li><p><strong>Heart Health</strong>: Carrots are high in <strong>potassium</strong>, which helps maintain <strong>healthy blood pressure levels</strong> and reduces the risk of stroke and cardiovascular disease.</p></li><li><p><strong>Cancer Prevention</strong>: The <strong>antioxidants</strong> (such as beta-carotene and other carotenoids) in carrots have been shown to reduce the risk of certain cancers by fighting oxidative stress and inflammation.</p></li></ol></div>', '<p><strong>Climate</strong>: Carrots prefer <strong>cool</strong> growing conditions, thriving in <strong>temperatures between 55°F and 75°F (13°C to 24°C)</strong>. They can be grown in spring and fall, as they tolerate light frost.</p>', '<p><span style=\"margin: 0px; padding: 0px; color: rgb(32, 33, 36); font-family: arial, sans-serif; font-size: 16px;\">Offers a </span><span style=\"margin: 0px; padding: 0px; color: rgb(32, 33, 36); font-family: arial, sans-serif; font-size: 16px;\">15 to 30-day window</span><span style=\"margin: 0px; padding: 0px; color: rgb(32, 33, 36); font-family: arial, sans-serif; font-size: 16px;\"> in which customers can return a product and ask for a refund. Some businesses extend that period up to 90 days. Regardless of the time frame you choose, ensuring that you actually have a time frame is essential.</span><br></p>', 16, 1, 1, 66),
(85, 'GREEN CABBAGE', '15', '20', 20, 'product-featured-85.png', '<ul><li><div style=\"text-align: justify;\"><strong>Green cabbage</strong>, often simply referred to as <strong>cabbage</strong>, is one of the most commonly grown vegetables around the world. It belongs to the <strong>Brassicaceae family</strong> (also known as the mustard family) and is closely related to other cruciferous vegetables like broccoli, cauliflower, kale, and Brussels sprouts.</div><div style=\"text-align: justify;\">The leaves are usually light green to medium green in color, with a smooth texture. The outer leaves may have a slightly waxy coating.</div></li><li style=\"text-align: justify;\">The head can range in size from small (about 1-2 lbs) to large (up to 10 lbs or more), depending on the variety.</li><li style=\"text-align: justify;\">The inner leaves of the cabbage head are typically lighter in color and more tender than the outer layers, which are thicker and sometimes slightly more coarse.</li></ul>', 'Varieties:\r\n\r\nEarly Season: These varieties mature quickly (within 60-70 days) and are typically smaller in size. They have tender leaves and a milder flavor.\r\nLate Season: These varieties take longer to mature (up to 90-100 days) and often produce larger, denser heads. Late-season cabbages are more suitable for storage and have a stronger, more robust flavor.\r\nStorage:\r\n\r\nCabbage should be stored in a cool, dry place, ideally in the refrigerator. When stored properly, it can last for 2-3 weeks.\r\nTo keep cabbage fresh, remove any damaged or outer leaves and store it in a plastic bag or wrap it in a damp cloth.', '<ul class=\"a-unordered-list a-vertical a-spacing-mini\" style=\"margin-right: 0px; margin-bottom: 0px; margin-left: 18px; color: rgb(15, 17, 17); padding: 0px; font-family: \" amazon=\"\" ember\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\"><li style=\"list-style: disc; overflow-wrap: break-word; margin: 0px;\"><span class=\"a-list-item\" style=\"overflow-wrap: break-word; display: block;\"><strong>Vitamins &amp; Minerals</strong>:<ul><li><strong>Vitamin C</strong>: Cabbage is an excellent source of vitamin C, which is essential for immune function and skin health.</li><li><strong>Vitamin K</strong>: Plays a role in blood clotting and bone health.</li><li><strong>Vitamin A</strong>: Present in small amounts, beneficial for eye health.</li><li><strong>Folate</strong>: Important for cell division and DNA synthesis.</li><li><strong>Potassium</strong>: Helps in regulating blood pressure and maintaining proper heart function.</li><li><strong>Calcium</strong>: A small amount of calcium for bone health.</li><li><strong>Iron</strong>: Essential for red blood cell production.</li><li><h3><strong>Health Benefits</strong>:</h3><ol><li><strong>Rich in Antioxidants</strong>: Green cabbage contains <strong>vitamins C and E</strong>, which help combat free radicals in the body, reducing oxidative stress and lowering the risk of chronic diseases.</li><li><strong>Digestive Health</strong>: The high fiber content supports healthy digestion and regular bowel movements. Cabbage is often used in diets to manage constipation.</li><li><strong>Anti-inflammatory</strong>: Cabbage has natural <strong>anti-inflammatory properties</strong>, thanks to compounds like <strong>glucosinolates</strong>.</li><li><strong>Heart Health</strong>: Rich in <strong>potassium</strong> and <strong>fiber</strong>, cabbage supports heart health by helping regulate blood pressure and cholesterol levels.</li><li><strong>Weight Loss</strong>: Low in calories and high in fiber, cabbage is often included in weight loss diets as it helps promote satiety and reduces overall calorie intake.</li></ol></li></ul></span></li></ul>', '<p><span style=\"color: rgb(51, 51, 51); font-size: 14px;\">Ripe and Excelent good</span><br></p>', '<p><span style=\"margin: 0px; padding: 0px; color: rgb(32, 33, 36); font-family: arial, sans-serif; font-size: 16px;\">Customers can return a product and ask for a refund. Some businesses extend that period up to 90 days. Regardless of the time frame you choose, ensuring that you actually have a time frame is essential.</span><br></p>', 17, 1, 1, 71);
...
(6, 'Free Shipping', 'Enjoy free shipping inside ph.', 'service-6.png'),
...
CREATE TABLE `tbl_settings` (
  ...
  `contact_fax` varchar(500) NOT NULL,
  `contact_map_iframe` text NOT NULL,
  `receive_email` varchar(500) NOT NULL,
  `receive_email_subject` varchar(500) NOT NULL,
  ...
  `banner_login` varchar(500) NOT NULL,
  `banner_registration` varchar(500) NOT NULL,
  `banner_forget_password` varchar(500) NOT NULL,
  `banner_reset_password` varchar(500) NOT NULL,
  `banner_search` varchar(500) NOT NULL,
  `banner_cart` varchar(500) NOT NULL,
  `banner_checkout` varchar(500) NOT NULL,
  `banner_product_category` varchar(500) NOT NULL,
  `banner_blog` varchar(500) NOT NULL,
  `cta_title` varchar(500) NOT NULL,
  `cta_content` text NOT NULL,
  `cta_read_more_text` varchar(500) NOT NULL,
  `cta_read_more_url` varchar(500) NOT NULL,
  `cta_photo` varchar(500) NOT NULL,
  `featured_product_title` varchar(500) NOT NULL,
  `featured_product_subtitle` varchar(500) NOT NULL,
  `latest_product_title` varchar(500) NOT NULL,
  `latest_product_subtitle` varchar(500) NOT NULL,
  `popular_product_title` varchar(500) NOT NULL,
  `popular_product_subtitle` varchar(500) NOT NULL,
  `testimonial_title` varchar(500) NOT NULL,
  `testimonial_subtitle` varchar(500) NOT NULL,
  `testimonial_photo` varchar(500) NOT NULL,
  `blog_title` varchar(500) NOT NULL,
  `blog_subtitle` varchar(500) NOT NULL,
  `newsletter_text` text NOT NULL,
  `paypal_email` varchar(500) NOT NULL,
  `stripe_public_key` varchar(500) NOT NULL,
